...
public class GenerationEvenements {
	...
	Evenement evAlea3 = new Evenement("Le prof a 1h00 de retard","J'attends ","je rentre chez moi","Je scanne les cours de mon copain",-10,35,10,-35,20,-14,25,-20,-5,0.2,new Date(2,2,13));
	...
	Evenement evAlea11 = new Evenement("Mon pote m'appelle pour boire un verre","Ca finit à 5h00 du mat et me fais arreter par les flics","J'y vais mais je bois de la grenadine ",40,10,-40,0,-26,-10,0.2,new Date(2,2,20));
