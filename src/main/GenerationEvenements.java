...
public class GenerationEvenements {
	...
	Evenement ev1 = new Evenement("Premier Amphi de l'année","J'y vais !","J'y vais pas","J'arrive en retard",0,15,30,-10,10,0,20,-20,0,new Date(1,1,13));
	Evenement ev2 = new Evenement("Soirée de reprise !","J'y vais !","J'y vais pas",30,-25,-15,15,-15,0,new Date(1,1,20));
	...
	Evenement evAlea10 = new Evenement("Mon pote me propose d'aller au cinéma","Je dois reviser mon systeme","Regarder le film ",-20,20,-10,20,30,-20,0.2,new Date(1,5,8));
	...
	Evenement ev26 = new Evenement("Tu as presque fini les deux semaines, choisi la bonne réponse, quel est le meilleur jeu presenté ?","Celui ci","Les autres jeux",0,-50,0,-50,0,-50,new Date(2,7,22));
